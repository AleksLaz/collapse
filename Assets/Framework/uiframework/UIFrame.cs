...
namespace deVoid.UIFramework
{
    ...
    /// </summary>
    public class UIFrame : MonoBehaviour, IScreensValidator
	{
		...
		//public bool OpenWindowIfClosed(string screenId)
		//{
		...
		bool IScreensValidator.IsWindowRegistered(string id)
		{
			return windowLayer.IsScreenRegistered(id);
		}

		bool IScreensValidator.IsPanelRegistered(string id)
		{
			return panelLayer.IsScreenRegistered(id);
		}
	}
}
